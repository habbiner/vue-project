            ...
            <div class="w-full">   
                <div class="flex gap-8 justify-center">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                        <p class="text-xs text-cinzaEscuro mt-1 ml-4">{{ minTemp }}/{{ maxTemp }}° | {{ condicao }}</p>
                        </div>
                    </div>
                    </div>
                ...
                <div class="flex bg-blue items-center">
                    ...
                    <VueApexCharts width="100%" height="150" type="bar" :options="barChartOptions" :series="barSeries" />
                    </div>
                    <button class="w-[25%] h-20 bg-verdeButton mt-6 rounded-xl ml-[10em] flex items-center justify-center text-base font-bold text-black hover:bg-green-600 transition">
                    RELATÓRIOS
                    </button>
                </div>
                </div>
